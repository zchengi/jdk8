...
public class StreamTest1 {
    public static void main(String[] args) {
        ...
        Student student1 = new Student("zhang", 80);
        Student student2 = new Student("li", 90);
        Student student3 = new Student("wang", 100);
        Student student4 = new Student("zhao", 90);
        Student student5 = new Student("zhao", 90);
        ...
        System.out.println("count: " + students.stream().filter(student -> student.getScore() > 80).collect(counting()));
        System.out.println("count: " + students.stream().filter(student -> student.getScore() > 80).count());
        System.out.println("----------");
        ...
        System.out.println(students.stream().map(Student::getName).collect(joining(", ")));
        System.out.println(students.stream().map(Student::getName).collect(joining(", ", "<String>", "</String>")));
        System.out.println("----------");
        ...
        Map<Boolean, Map<Boolean, List<Student>>> map3 = students.stream().collect(partitioningBy(student -> student.getScore() > 80,
